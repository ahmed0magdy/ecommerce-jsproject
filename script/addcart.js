...
<tr>
<div class="product">
<td><ion-icon style="cursor:pointer" name="close-circle"></ion-icon></td>
<td><img src="${item.img}" style="width: 100px;" /></td>
             <td>   <span class="sm-hide">${item.name}</span></td>
            </div>


           <td> <div class="price sm-hide">$ ${item.price},00</div></td></td>
        <td>    <div class="quantity">
          ...
          <td>  <div class="total">$ ${item.quantity * item.price},00</div> </td>
